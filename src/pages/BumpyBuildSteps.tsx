...
import { Bot, ArrowRight, MapPin, Code, Cpu, Zap, Cog, Wrench, Battery, Wifi, Users, Network, Compass, Gauge, HardDrive, Camera, Monitor, Cherry as Raspberry, BatteryCharging, Car as SdCard, Package, ShoppingCart } from 'lucide-react';
  ...
  const products = [
    {
      ...
      features: [
        ...
        },
        {
          ...
          description: "3+ hours of operation"
        },
        {
